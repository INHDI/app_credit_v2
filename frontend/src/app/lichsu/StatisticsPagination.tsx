...
interface StatisticsPaginationProps {
  currentPage: number;
...
export default function StatisticsPagination({
  currentPage,
  setCurrentPage,
  totalPages,
  startIndex,
        ...
        <div className="text-sm text-slate-600 font-medium">
          {countAllItems > 0 ? (
            ...
            <>
              ...
              tổng số{" "}
              <span className="font-semibold text-slate-800">0</span> bản ghi thống kê
            </>
          )}
        </div>
